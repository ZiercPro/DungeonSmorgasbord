...
namespace ZiercCode._DungeonGame._Scripts.WeaponClass
{
    ...
    /// 现代子弹类射弹
    /// </summary>
    public class Projectile_Bullet : GroundProjectile
    {
        [SerializeField]
        ...
        {
            if (_rangeDetect.DetectInBoxByLayer(myWeapon.myHolder.targetFaction, myTransform.position,
        ...
        private void Split()
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                particle.transform.rotation = myTransform.rotation;
