...
namespace ZiercCode._DungeonGame.NPC
{
    ...
    public class ShowName : MonoBehaviour
    {
        ...
        private RangeDetector _rangeDetect = new(MAX_DETECT_NUM);

        [SerializeField]
        private TextMeshPro textMeshPro; //显示名称的textMesh组件

        [SerializeField]
        private float minRadius = 0.8f; //最小显示范围，小于这个距离就显示名称
        ...
        private bool IsPlayerInRange()
        {
            ...
            return _rangeDetect.DetectInCircleByTag(playerTagString, transform.position, minRadius);
        }
