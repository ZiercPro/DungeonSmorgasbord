...
public class SettingPanel : BasePanel
{
    ...
    public override void OnEnter()
    {
        ...
        //音量设置逻辑
        UITool.GetComponentInChildrenUI<Slider>("EnvironmentSlider").onValueChanged.AddListener(AudioPlayerManager.Instance.SetEnvironmentVolume);
        UITool.GetComponentInChildrenUI<Slider>("MasterSlider").onValueChanged.AddListener(AudioPlayerManager.Instance.SetMasterVolume);
        UITool.GetComponentInChildrenUI<Slider>("MusicSlider").onValueChanged.AddListener(AudioPlayerManager.Instance.SetMusicVolume);
        UITool.GetComponentInChildrenUI<Slider>("SFXSlider").onValueChanged.AddListener(AudioPlayerManager.Instance.SetSFXVolume);
        //页面切换逻辑
        UITool.GetComponentInChildrenUI<Toggle>("VolumeToggle").onValueChanged.AddListener(ison => { UITool.GetComponentInChildrenUI<RectTransform>("VolumeSettings").gameObject.SetActive(ison); });
        UITool.GetComponentInChildrenUI<Toggle>("OtherToggle").onValueChanged.AddListener(ison => { UITool.GetComponentInChildrenUI<RectTransform>("OtherSettings").gameObject.SetActive(ison); });
        UITool.GetComponentInChildrenUI<Toggle>("LanguageToggle").onValueChanged.AddListener(ison => { UITool.GetComponentInChildrenUI<RectTransform>("LanguageSettings").gameObject.SetActive(ison); });
        //语言设置逻辑
        UITool.GetComponentInChildrenUI<Toggle>("Chinese").onValueChanged.AddListener(ison => { if (ison) GameRoot.Instance.LanguageManager.SetLanguage("Chinese"); });
        UITool.GetComponentInChildrenUI<Toggle>("English").onValueChanged.AddListener(ison => { if (ison) GameRoot.Instance.LanguageManager.SetLanguage("English"); });
        //返回逻辑
        UITool.GetComponentInChildrenUI<Button>("BackButton").onClick.AddListener(() => { PanelManager.Pop(); });
        //读取默认值
        Toggle[] languageTgls = UITool.GetComponentInChildrenUI<Transform>("LanguageSettings").GetComponentsInChildren<Toggle>();
        ...
        UITool.GetComponentInChildrenUI<Slider>("EnvironmentSlider").value = GameRoot.Instance.settingsData.EnvironmentVolume;
    ...
    public override void OnExit()
    {
        ...
        //同步设置值
        GameRoot.Instance.settingsData.EnvironmentVolume = UITool.GetComponentInChildrenUI<Slider>("EnvironmentSlider").value;
