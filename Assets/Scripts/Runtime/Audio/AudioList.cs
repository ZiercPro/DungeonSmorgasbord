...
{
    public AudioBase menuBgm = new AudioBase(new AudioType("Audio/8Bit Music Album - 051321/MenuBgm"), 1, true,
        true, AudioPlayerManager.Instance.Music());

    public AudioBase idleBgm = new AudioBase(new AudioType("Audio/8Bit Music Album - 051321/IdleBgm"), 1,
        true, false, AudioPlayerManager.Instance.Music());
