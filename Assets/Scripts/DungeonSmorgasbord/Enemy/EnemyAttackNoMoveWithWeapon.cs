...
{
    public class EnemyAttackNoMoveWithWeapon : EnemyAttackStateBase
    {
        ...
        public EnemyAttackNoMoveWithWeapon(Enemy enemyBase, EnemyStateMachine stateMachine, Animator animator,
        ...
        public override void FrameUpdate()
        {
            ...
            {
                //瞄准敌人
                _weaponUserHelper.OnViewPositionChange(EnemyBase.GetTarget().transform.position);
